          ...
          <div class="row">
            <div class="col-12">
              ...
              <?php elseif ($engagement): ?>
                <h1 class="mb-4">Review Materiality Calculations for <?php echo htmlspecialchars($engagement['client_name']); ?> (<?php echo htmlspecialchars($engagement['engagement_year']); ?> - <?php echo htmlspecialchars($engagement['period']); ?>)</h1>
                ...
                <!-- List of Materiality Calculations for Review -->
                <div class="card">
                  <div class="card-header">
                    <h4>Materiality Calculations</h4>
                  </div>
                  <div class="card-body">
