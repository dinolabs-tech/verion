          ...
          <div class="row">
            <div class="col-12">
              ...
              <?php elseif ($engagement): ?>
                <h1 class="mb-4">Review Compliance Checklists for <?php echo htmlspecialchars($engagement['client_name']); ?> (<?php echo htmlspecialchars($engagement['engagement_year']); ?> - <?php echo htmlspecialchars($engagement['period']); ?>)</h1>
                ...
                <!-- List of Compliance Checklists for Review -->
                <div class="card">
                  <div class="card-header">
                    <h4>Compliance Checklists</h4>
                  </div>
                  <div class="card-body">
