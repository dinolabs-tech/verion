          ...
          <div class="row">
            <div class="col-12">
              ...
              <?php elseif ($engagement): ?>
                <h1 class="mb-4">Review Reconciliations for <?php echo htmlspecialchars($engagement['client_name']); ?> (<?php echo htmlspecialchars($engagement['engagement_year']); ?> - <?php echo htmlspecialchars($engagement['period']); ?>)</h1>
                ...
                <!-- List of Reconciliations for Review -->
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <?php else: ?>
                      <div class="table-responsive">
                        <table class="table table-striped table-hover" id="basic-datatbles">
                          <thead>
                            <tr>
                              <th>ID</th>
                              <th>Type</th>
